...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Les jours de la semaine'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Img> imgs = const [
    const Img("assets/images/girafe1.png", "Gi"),
    const Img("assets/images/girafe2.png", "ra"),
    const Img("assets/images/girafe3.png", "ffe"),
  ];
      ...
      body: Column(
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Text('Text'),
            Switch(value: imgMode, onChanged: (value) => setState(() => imgMode = value)),
            Text('Image'),
          ]),
          preview,
          Center(
              child: imgMode
                  ? OrderableStack<Img>(
                      items: imgs,
                      itemSize: gSize.width < gSize.height ? Size(gSize.width / 3, gSize.height - 200.0) : Size(200.0, gSize.height - 300.0),
                      margin: 0.0,
                      itemBuilder: imgItemBuilder,
                      onChange: (List<Object> orderedList) => orderNotifier.value = orderedList.toString())
...
class OrderPreviewState extends State<OrderPreview> {
  ...
  void initState() {
    super.initState();
    widget.orderNotifier.addListener(() => setState(() => data = widget.orderNotifier.value));
  }
